    ...
    , ui(new Ui::MainWindow)
{
    ...
    if(file.exists()){
        while(!file.atEnd()){
            ...
            deputat[amount].setChamber(list[4].toInt());
...
void MainWindow::on_addInfo_clicked()
{
    ...
    ui->age->clear();
    str = ui->chamber->text();
    deputat[amount].setChamber(str.toInt());
    ui->chamber->clear();
    str = ui->Partya->text();
...
void MainWindow::show_data(){
    ...
    ui->textBrowser->setText(deputat[chosen].getLastName()+"\n"+deputat[chosen].getFirstName()+"\n"+deputat[chosen].getGender()+"\n"+QString::number(deputat[chosen].getAge())+"\n"
                             +QString::number(deputat[chosen].getChamber())+"\n"+deputat[chosen].getPartya());
}
...
void MainWindow::on_Edit_clicked()
{
    ...
    ui->chamber->setText(QString::number(deputat[chosen].getChamber()));
...
void MainWindow::on_Save_clicked()
{
    ...
    ui->age->clear();
    str = ui->chamber->text();
    deputat[chosen].setChamber(str.toInt());
    ui->chamber->clear();
    str = ui->Partya->text();
...
void MainWindow::on_Search_clicked()
{
    ...
    if(str==""){
        ...
        if(found) ui->textBrowser->setText(deputat[searched].getLastName()+"\n"+deputat[searched].getFirstName()+"\n"+deputat[searched].getGender()+"\n"+QString::number(deputat[searched].getAge())+"\n"
                                           +QString::number(deputat[searched].getChamber())+"\n"+deputat[searched].getPartya());
